...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-gradient-to-br from-fetra-pink/5 via-white to-fetra-olive/5">
        <div className="max-w-5xl mx-auto px-4 lg:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">{t('tutorial.title')}</h2>
          ...
          <div className="relative rounded-3xl overflow-hidden brand-shadow bg-white p-2 md:p-4">
            <VideoEmbed
              src="https://youtu.be/lMTlX0SJKno"
          ...
          <div className="text-center mt-8">
            <a
              href="https://youtu.be/lMTlX0SJKno"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-fetra-olive text-white rounded-xl font-semibold hover:bg-fetra-olive/90 transition-all hover:scale-[1.02] active:scale-95 shadow-lg hover:shadow-xl"
            >
